// ฟอร์ม submit
    document.getElementById('registrationForm').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            await fetch('https://script.google.com/macros/s/AKfycby53KL2DUHafKLaG1dkRJMOOSXi3P-Els6rjnUWcXr5SJSz0htMVG1sNwD69gHdp2VP/exec', {
                method: 'POST',
    ...
    async function loadData() {
        try {
            const res = await fetch('https://script.google.com/macros/s/AKfycby53KL2DUHafKLaG1dkRJMOOSXi3P-Els6rjnUWcXr5SJSz0htMVG1sNwD69gHdp2VP/exec');
